...
<script type="text/javascript">
	$(document).ready(function(){	
		//$('#team-create-notice1').xheditor({upImgUrl:"/zuitu/upload.php",upImgExt:"jpg,jpeg,gif,png"});
	});	
	function submitForm(){$('#-user-form').submit();}
</script>
            ...
            <div class="box-content">
				...
				<form id="-user-form" method="post" action="/manage/team/edit.php?id=<?php echo $team['id']; ?>" enctype="multipart/form-data" class="validator">
					...
					<div class="field" id="field_audit">
						<label>是否审核通过</label>
						<input type="text" size="5" name="audit" id="team-audit" class="number" value="<?php echo $team['audit']; ?>" require="true" datatype="number" />
